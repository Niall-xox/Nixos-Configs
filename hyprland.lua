...
-- note* in general we use absolute path dotfiles rather than require() as the relative path will look for the files in our nixos folder not the folder the hyprland.lua is symlinked too
...
------------------------------------
---- Nixos Noctalia Adjustments ----
------------------------------------

-- Custom Theming Script --
...
hl.config({
	...
	disable_splash_rendering = true, -- Removes splash text on default hyprland wallpaper
    },
})
...
-- Steam x11 compatibility setting
