...
-- Default springs
hl.curve("easy",           { type = "spring", mass = 1, stiffness = 285.0532, dampening = 23.7410466 })
...
-- hl.bind(mainMod .. " + S",         hl.dsp.workspace.toggle_special("magic")) -- overwritten by noctalia
